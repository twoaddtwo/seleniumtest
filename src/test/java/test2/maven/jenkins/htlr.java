...
public class htlr {
  ...
  public void luru() throws InterruptedException {
	  ...
	  Thread.sleep(3000);
	  driver.findElement(By.xpath("//*[@id=\"27\"]")).click();//进入合同录入界面
      Thread.sleep(3000);
      
      driver.switchTo().frame(driver.findElement(By.xpath("//*[@id=\"ip27\"]")));
      Thread.sleep(6000);
...
//      driver.findElement(By.xpath("//*[@id=\"sureChosePartner\"]")).click();
	  ...
	  String month = String.valueOf(c.get(Calendar.MONTH)+10);   

	  String date = String.valueOf(c.get(Calendar.DATE)+10);    
	  ...
	  String chejianumber = "L00"+year+month+date+hour+minute+second;
